...
def run_single_benchmark(args):
    ...
    try:
        ...
        try:
            ...
            # 获取CPU逻辑核心数
            cpu_count = psutil.cpu_count(logical=True)  # 获取逻辑核心数(包含超线程)
            ...
            result = {
                ...
                'cpu_usage': cpu_usage,
                'cpu_usage_total': cpu_usage * cpu_count,  # 保存总的CPU使用率
...
def run_benchmark(config_file, num_runs=200):
    try:
        ...
        delete_network_namespaces()  # 确保命名空间被删除
